...
export const styleguideRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'textsizes', loadComponent: () => import('./textsizes/textsizes.component').then((m) => m.TextsizesComponent) },
      { path: 'buttons', loadComponent: () => import('./buttons/buttons.component').then((m) => m.ButtonsComponent) },
      { path: 'jobcards', loadComponent: () => import('./job-cards/job-cards.component').then((m) => m.JobCardsComponent) },
      { path: 'companycards', loadComponent: () => import('./company-cards/company-cards.component').then((m) => m.CompanyCardsComponent) },
